...
public class WarriorTest {
	...
	private final static float WARRIOR_SHIELD = 10;
	private final static Weapon VALID_WEAPON = Staffs.Staff_1.getWeapon();
	...
	public void before() {
		...
		warrior = new Warrior(DRAWABLE_TEXTURE, tile, GAMECHARACTER_NAME, GAMECHARACTER_HEALTH, weapon, GAMECHARACTER_LEVEL,
				GAMECHARACTER_ARMOR, HERO_LIVES, WARRIOR_SHIELD);
	...
	public void move_EASTDirectionAndNoUnavailablePositionsUntilReachingExteriorWallsPlus1_stopsMovingAtWall() {
		...
		int hitBoxWidth = ((WarriorTextures) hero.getTexture()).getHitBoxSize().getWidth();
	...
	public void move_SOUTHDirectionAndNoUnavailablePositionsUntilReachingExteriorWallsPlus1_stopsMovingAtWall() {
		...
		int hitBoxHeight = ((WarriorTextures) hero.getTexture()).getHitBoxSize().getHeight();
