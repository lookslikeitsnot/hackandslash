...
public class Skeleton extends Ennemy{
	...
	public Skeleton(Path skinPath, String name, float health, Weapon weapon, int level, float armor, Set<Droppable> droppables) {
		super(skinPath, name, health, weapon, availableWeapons, level, armor, droppables);
	}
